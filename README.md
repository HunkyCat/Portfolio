...
| 6.   | [Анализ. Исследование объявлений о продаже квартир](link) | Необходимо провести анализ архива объявлений о продаже квартир и выделить факторы, влияющие на ценообразование | python, pandas, matplotlib       |
